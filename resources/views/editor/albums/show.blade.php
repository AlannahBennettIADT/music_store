    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @forelse ($songs as $song)
                <x-card>
                    <a href="{{route('editor.songs.show',$song)}}" class="font-bold text=2x1"> {{$song->song_name}}</a>
                </x-card>
            @empty
            ...
            <x-primary-button><a href="{{ route('editor.albums.edit',$album) }}"> Edit</a></x-primary-button>
